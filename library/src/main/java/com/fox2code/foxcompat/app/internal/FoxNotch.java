...
public final class FoxNotch {
    private static final String TAG = "FoxNotch";

    public static int getNotchHeight(FoxActivity compatActivity) {
    ...
    private static int getNotchHeightModern(FoxActivity compatActivity) {
    ...
    private static int getNotchHeightLegacy(FoxActivity compatActivity) {
